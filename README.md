...
4. Find a decrypted YTMusic .ipa file (we cannot provide you this due to legal reasons) and upload it to a file provider(filebin.net or Dropbox is recommended) . Paste the url to the necessary field and click "Run workflow".
  4.a. Go to https://github.com/dayanch96/YTMusicUltimate/forks?include=active&page=2&period=2y&sort_by=last_updated
    b. Pick one of the forks that have a release. Something like https://github.com/bitmap4/YTMusicUltimate/releases/tag/Release
    c. Download the .ipa file locally
    d. Upload it to filebin.net like - https://filebin.net/4vehg0zm2uqrpbix
    e. Then When you run the workflow, paste https://filebin.net/4vehg0zm2uqrpbix/YTMusicUltimate.ipa
    f. Run the workflow
    g. Once that's done, go to https://github.com/nachiketdhamankar/YTMusicUltimate/releases and publish the release
    h. Download the .ipa file on your phone
    i. Connect to the local dev VPN
    j. Go to SideStore, click on My Apps, click + sign, select the .ipa file
6. Wait for the build to finish. You can download the tweaked IPA from the releases section of your forked repo. (If you can't find the releases section, go to your forked repo and add /releases to the url. i.e github.com/user/YTMusicUltimate/releases)
